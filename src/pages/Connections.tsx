...
import { closeAllConnectionsAPI, closeSingleConnectionAPI, fetchGeoIPAPI } from '~/apis'
import {
  Button,
...
export default () => {
  ...
  const getIPCode = (ip: string) => {
    const countryCode = fetchGeoIPAPI(ip).code    
                      ...
                      return (
                        ...
                        >
                          {cell.getIsGrouped() ? (
                            ...
                            cell.column.id === "host"?
                            getIPCode(cell.row.original.metadata.destinationIP)+flexRender(cell.column.columnDef.cell, cell.getContext())+`(${cell.row.original.metadata.destinationIP})`
                            :
